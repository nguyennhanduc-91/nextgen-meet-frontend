...
# 4. SCRIPT NHẮM BẮN MỤC TIÊU CHÍNH XÁC
RUN cat <<'EOF' > rebrand.js
const fs = require('fs');
const path = require('path');

// Quét toàn bộ file trong src/ (Sửa triệt để lỗi sót Component)
function patchSrc(dir) {
    ...
    for (const file of files) {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            // =========================================================
            // MỤC TIÊU 2: THIẾT KẾ LẠI GIAO DIỆN TRANG CHỦ ENTERPRISE
            // =========================================================
            if (fullPath.endsWith('page.tsx')) {
                ...
                // Đập bỏ Slogan lỗi "Thanh Nguyen, Group" -> Xây mới hoàn toàn
            ...
            // =========================================================
            // MỤC TIÊU 3: SEO META (THẺ ZALO/FACEBOOK)
            // =========================================================
            ...
            // =========================================================
            // MỤC TIÊU 4: DỊCH 100% CÁC NÚT (Bao gồm "Start Meeting")
            // =========================================================
...
patchSrc('src'); // Bắt đầu quét từ src

// =========================================================
// MỤC TIÊU 5: VIỆT HÓA LÕI MENU BÊN TRONG PHÒNG HỌP (TỪ THƯ VIỆN)
// =========================================================
